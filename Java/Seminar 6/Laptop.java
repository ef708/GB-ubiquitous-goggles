...
public class Laptop {
    ...
    public Laptop(String manufacturer, String model, double price, int ram, int hdd, String os, String color,
            double screenSize) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Choose filters to apply:");
